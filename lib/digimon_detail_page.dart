    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return new AlertDialog(
            ...
            content: new Text("Vinga! No siguis tan pessimista!"),
            actions: <Widget>[
              new TextButton(
                child: new Text('Tornar a intentar'),
    ...
    return new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Text('${widget.digimon.levelDigimon}',
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: new Text('Coneix ${widget.digimon.name}'),
      ),
      body: new ListView(
